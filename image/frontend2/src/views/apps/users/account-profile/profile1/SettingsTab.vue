      ...
      <v-card variant="flat">
        <v-card variant="outlined">
          ...
          <v-card-text>
            ...
            <v-switch color="primary" v-model="email1" hide-details class="wrap-label">
              <template v-slot:label>
                <span class="text-truncate">Email Notification</span>
              </template></v-switch
            >

            <v-switch color="primary" v-model="email2" hide-details class="wrap-label">
              <template v-slot:label>
            ...
            <v-switch color="primary" v-model="email3" hide-details class="wrap-label">
              <template v-slot:label>
                <span class="text-truncate">have new notifications</span>
              </template>
            </v-switch>

            <v-switch color="primary" v-model="email4" hide-details class="wrap-label">
              <template v-slot:label>
                <span class="text-truncate">you're sent a direct message</span>
              </template>
            </v-switch>

            <v-switch color="primary" v-model="email5" hide-details class="wrap-label">
              <template v-slot:label>
            ...
            <v-switch color="primary" v-model="email6" hide-details class="wrap-label">
              <template v-slot:label>
                <span class="text-truncate">Upon new order</span>
              </template>
            </v-switch>

            <v-switch color="primary" v-model="email7" hide-details class="wrap-label">
              <template v-slot:label>
                <span class="text-truncate">New membership approval</span>
              </template>
            </v-switch>

            <v-switch color="primary" v-model="email8" hide-details class="wrap-label">
              <template v-slot:label>
            ...
            <v-checkbox color="primary" hide-details v-model="checkbox1" class="wrap-label">
              <template v-slot:label>
                <span class="text-truncate">News about PCT-themes products and feature updates</span>
              </template>
            </v-checkbox>
            <v-checkbox color="primary" hide-details v-model="checkbox2" class="wrap-label">
              <template v-slot:label>
                <span class="text-truncate">Tips on getting more out of PCT-themes</span>
              </template>
            </v-checkbox>
            <v-checkbox color="primary" hide-details v-model="checkbox3" class="wrap-label">
              <template v-slot:label>
                <span class="text-truncate">Things you missed since you last logged into PCT-themes</span>
              </template>
            </v-checkbox>
            <v-checkbox color="primary" hide-details v-model="checkbox4" class="wrap-label">
              <template v-slot:label>
                <span class="text-truncate">News about products and other services</span>
              </template>
            </v-checkbox>
            <v-checkbox color="primary" hide-details v-model="checkbox5" class="wrap-label">
              <template v-slot:label>
