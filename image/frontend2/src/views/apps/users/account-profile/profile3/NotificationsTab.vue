      ...
      <v-card variant="flat">
        <v-card variant="outlined">
          ...
          <v-card-text>
            ...
            <v-checkbox color="primary" hide-details density="compact" class="wrap-label" v-model="sub1">
              <template v-slot:label>
                <span class="text-truncate">Product Announcements and Updates</span>
              </template>
            </v-checkbox>
            <v-checkbox color="primary" hide-details density="compact" class="wrap-label" v-model="sub2">
              <template v-slot:label>
                <span class="text-truncate">Events and Meetups</span>
              </template>
            </v-checkbox>
            <v-checkbox color="primary" hide-details density="compact" class="wrap-label" v-model="sub3">
              <template v-slot:label>
                <span class="text-truncate">User Research Surveys</span>
              </template>
            </v-checkbox>
            <v-checkbox color="primary" hide-details density="compact" class="wrap-label" v-model="sub4">
              <template v-slot:label>
    ...
    <v-col cols="12" lg="4">
      <v-card variant="flat">
        <v-card variant="outlined">
          ...
          <v-divider></v-divider>
          <v-card-text>
            <v-checkbox v-model="checkbox1" hide-details density="compact" class="wrap-label">
              <template v-slot:label>
